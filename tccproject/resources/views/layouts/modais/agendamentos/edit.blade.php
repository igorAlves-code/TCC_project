...
<div class="modal fade" id="editAgendamento{{ $agendamento->id . '/' . $date }}" data-backdrop="static"
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select form-control" name="recurso" id="equipmentScheduling"
                            ...
                            <option selected="true" disabled="disabled">{{ $agendamento->recurso }}</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-control" name="ambiente" id="enviromentScheduling"
                            aria-label="Default select example">
                            <option selected="true" disabled="disabled">{{ $agendamento->ambiente }}</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="start" id="dateWithdrawalScheduling"
                            aria- value="<?php echo $date; ?>" required>
                    </div>
                    ...
                    <div class="mb-3" style="margin-bottom: 1rem !important;" id="containerHour">
                        <div>
                            ...
                            <select name="retirada" id="classStartScheduling" class="form-control" required>
                                <option selected="true" disabled="disabled">{{ $agendamento->retirada }}ªaula</option>
                        ...
                        <div>
                            ...
                            <select name="devolucao" id="classEndScheduling" class="form-control" required>
                                <option selected="true" disabled="disabled">{{ $agendamento->devolucao }}ªaula</option>
                                <option value="1">1ªaula</option>
                                <option value="2">2ªaula</option>
                                <option value="3">3ªaula</option>
                                <option value="4">4ªaula</option>
