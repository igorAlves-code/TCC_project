...
<div class="modal fade" id="editEquipment{{ $equipamento->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('equipments.update', $equipamento->id) }}" method="post">
                @method('patch')
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nomeEquipamento" aria-describedby="nameHelp"
                            required value="{{ $equipamento->nomeEquipamento }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="tipoEquipamento" aria-describedby="typeHelp"
                            required value="{{ $equipamento->tipoEquipamento }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="quantidadeEquipamento"
                            aria-describedby="numberHelp" required value="{{ $equipamento->quantidadeEquipamento }}">
                    </div>
                </div>
